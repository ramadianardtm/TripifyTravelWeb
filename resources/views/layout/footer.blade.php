<div class="container-fluid d-flex flex-row justify-content-center py-3" style="background-color:#EFF5EE; text-align:center;">
    <div style="width: 80%" class="">
        ...
        <div class="text-end" style=" font-size:20px;">
            ...
            <a href="https://www.instagram.com/" style="text-decoration: none; color:#1C651A" class="me-2">
                <i class="bi bi-instagram" ></i>
            </a>
            <a href="https://www.pinterest.com/" style="text-decoration: none; color:#1C651A">
                <i class="bi bi-pinterest"></i>
            </a>
        </div>
        <hr>
        <p class="text-end" style="color: #1C651A; font-size: 16px"> &#169; 2022</p>
    </div>
</div>